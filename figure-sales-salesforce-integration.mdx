...
This document describes the integration between Kastle AI and Figure's Salesforce instance for submitting call disposition data after call completion.
...
- `NO_ANSWER` - No answer from borrower
- `BUSY` - Line was busy
- `DO_NOT_CALL` - Borrower requested not to be called
- `APPOINTMENT_SCHEDULED` - Successfully scheduled appointment
- `BORROWER_DECEASED` - Borrower is deceased
