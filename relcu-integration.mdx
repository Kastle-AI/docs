...
### Stop Campaign Entity

Stop a specific entity in a campaign. This sets the entity's status to stopped and halts associated workflows for that entity.

#### Endpoint
```
POST /api/v1/campaigns/entities/stop/{org_name}/{campaign_id}/{entity_id}
```
...
```json
{
  "entity": "61e4e1e6-1a60-4099-8937-be39e660133a",
  "message": "Entity stopped successfully"
}
```
...
### Stop Multiple Campaign Entities

Stop multiple entities in a campaign in a single request.

#### Endpoint
```
POST /api/v1/campaigns/entities/stop-multiple/{org_name}/{campaign_id}
```
...
```json
{
  "entity_ids": ["61e4e1e6-1a60-4099-8937-be39e660133a", "5226d1e6-1a60-4099-8937-be29e660133b"]
}
```
...
{
  "entities": {
    "61e4e1e6-1a60-4099-8937-be39e660133a": 200,
    "5226d1e6-1a60-4099-8937-be29e660133b": 404
  },
  "success_count": 1
}
```
...
#### Error Responses
- `400 Bad Request` - Invalid request format or missing `entity_ids`
- `401 Unauthorized` - Invalid JWT or insufficient permissions
- `404 Not Found` - Campaign or organization not found
- `500 Internal Server Error` - Internal server error

#### NOTE: The response will return 407 if any of the entities are not found
---
...
```json
{
  "message": "Entity suppressed successfully"
}
```
...
```json
{
  "message": "Entity unsuppressed successfully"
}
```
...
#### Endpoint
```
POST /relcu/suppress-multiple-entities
```
...
```json
{
  "message": "Entities suppressed successfully"
}
```
...
#### Endpoint
```
POST /relcu/unsuppress-multiple-entities
```
...
```json
{
  "message": "Entities unsuppressed successfully"
}
```
