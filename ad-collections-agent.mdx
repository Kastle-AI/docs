...
**Endpoint:** `/ad-mortgage/{environment}/trigger-call`  
**Method:** POST  
**Content-Type:** application/json  
**Authentication:** JWT token required

Note: This endpoint triggers an automated collection call to the specified borrower. JWT authentication is required with valid AD Mortgage organization credentials. The environment may be `test` or `prod`.
...
**Endpoint:** `/ad-mortgage/{environment}/stop-entity/{entity_id}`  
**Method:** POST  
**Content-Type:** application/json  
**Authentication:** JWT token required
...
```json
{
  ...
  "data": {
    ...
    "reason": "string",
    "reasonCode": "string",
    "pending_calls_cancelled": "number"
  }
}
```
