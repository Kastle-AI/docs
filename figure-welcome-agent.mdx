...
**Endpoint:** `/figure-lending/welcome-call/prod/stop/<entity_id>`
**Method:** `PUT`
**Authentication:** JWT token required

This endpoint allows you to stop outbound calls for a specific entity. The entity will remain in the campaign but will no longer receive calls.
