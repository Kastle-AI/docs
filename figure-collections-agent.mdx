...
| TaxIDLastFour           | Last four digits of customer's social security number (exactly 4 digits)          | Number    |
...
| PhoneNumber             | Customer's phone number in E.164 format (e.g., +19876543210)                      | String    |
...
| PropertyZip             | Customer's property address - ZIP code (exactly 5 digits)                         | Number    |
...
| MailingZip              | Customer's mailing address - ZIP code (exactly 5 digits)                          | Number    |
...
| Language                | Code indicating the customer's preferred language (currently only "en" supported) | String    |
...
=======
| `AttorneyDetails` | Details of the Borrower's Attorney | Object | | Contains Attorney Name, Phone, Email. Null if AttorneyCommunicationRequested is false | 
>>>>>>> 9e3858a (Pg/collections docs update1 (#25))
