...
| `BorrowerName` | Full name of the borrower contacted | String | ⚠️ | Verified during call |
| `BorrowerType` | Type of borrower contacted | Enum | | Allowed values: `Primary`, `Secondary` |
...
| `CallOutcome` | Result of the call attempt | Enum | | Allowed values: `Connected`, `Voicemail`, `NoAnswer`, `Busy`, `Failed`, `DidNotDial`, `Transferred`, `Warm Transferred`, `Warm Transfer Failed` |
...
| `PaymentDetails` | Payment transaction information | Object | ⚠️ | Only populated if payment collected |
