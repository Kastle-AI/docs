...
| AccountType             | The type of account being used for automatic payments (checking or savings).      | String    |
| AccountNumberLastFour   | The last four digits of the customer's bank account number used for payments.     | Number    |
| RoutingNumber           | The last four digits of the bank routing number used for payments                 | Number    |
